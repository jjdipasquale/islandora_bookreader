...
BookReader.prototype.BRSearchCallback = function(results) {
    ...
    if (0 == results.matches.length) {
        var errStr  = 'No matches were found.  Please note: not all handwritten items have been transcribed yet.  Form more information, view <a href="/transcriptions/" target="_parent">transcription information</a>.';
        var timeout = 5000; // jd changed from 1000
...
BookReader.prototype.initNavbar = function() {
   ...
   // jd adding
   //$('#cBoxOverlay').draggable().resizable();
...
/* JD modifications and comments out */
    $("#BookReader").append(
          "<div id='BRtoolbar'>"
        +   "<span id='BRtoolbarbuttons'>"
        +     "<form action='javascript:br.search($(\"#textSrch\").val());' id='booksearch'><input type='search' id='textSrch' name='textSrch' val='' placeholder='Search inside'/><button type='submit' id='btnSrch' name='btnSrch'>GO</button></form>"

	// JD TURNING OFF FOR NOW
